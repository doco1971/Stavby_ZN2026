...
if not df_raw.empty:
    ...
    # --- 6. FORMULÁŘ (POUZE PRO SUPERVISORA) ---
    if st.session_state.role == "supervisor":
        with st.expander("➕ NOVÝ ZÁZNAM"):
            st.write("Zde bude formulář pro zadávání dat.")

    # --- 7. HTML TABULKA (23 SLOUPCŮ, MŘÍŽKA) ---
    html = '<div class="table-container"><table class="html-table">'
    # Fixní šířky sloupců (celkem 23)
    html += '<colgroup>'
    html += '<col style="width:35px"><col style="width:90px">' # Poř, Firma
    html += '<col style="width:115px">'*6 # Kat I (3x), Kat II (3x)
    html += '<col style="width:90px"><col style="width:250px"><col style="width:115px">' # Č.stavby, Název, Nabídka
    html += '<col style="width:115px"><col style="width:115px">' # Rozdíl, Vyfakt
    html += '<col style="width:85px">'*4 # Ukončení, Zrealiz, SOD, Ze dne
    html += '<col style="width:110px">'*2 # Objednatel, Stavbyved
    html += '<col style="width:115px"><col style="width:100px"><col style="width:115px"><col style="width:100px">' # Ceny, Faktura...
    html += '</colgroup>'
    ...
    st.error("Data nenalezena.")import streamlit as st
import pandas as pd
import numpy as np
